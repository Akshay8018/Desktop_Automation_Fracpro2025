...
public class ExcelReader {
    ...
    // ================= TEST DATA EXCEL =================
    private static final String TESTDATA_FILE_PATH =
            "D:\\FRACPRODeskAppPOC\\windows-automation-ai\\resources\\TestData.xlsx";

    // ================= TREATMENT SCHEDULE EXCEL =================
//    private static final String TREATMENT_SCHEDULE_FILE_PATH =
//            "D:\\FRACPRODeskAppPOC\\windows-automation-ai\\resources\\Fracpro2025_TreatmentSchedule.xlsx";
//
//    private static final String TREATMENT_SCHEDULE_SHEET =
//            "ScheduleData";
        ...
        try (FileInputStream fis = new FileInputStream(TESTDATA_FILE_PATH)) {
            ...
            if (sheet == null) {
                throw new RuntimeException(
                        "Sheet not found in TestData Excel: " + sheetName);
            }
            ...
            throw new RuntimeException(
                    "Failed to read Key-Value TestData Excel", e);
        }
...
//    private static InputStream getTreatmentScheduleStream() {
//        try {
//            return new FileInputStream(TREATMENT_SCHEDULE_FILE_PATH);
//        } catch (Exception e) {
//            throw new RuntimeException(
//                    "Treatment Schedule Excel not found: " +
//                            TREATMENT_SCHEDULE_FILE_PATH, e);
//        }
//    }
...
//
//        try (InputStream is = getTreatmentScheduleStream()) {
//
...
//            if (sheet == null) {
//                throw new RuntimeException(
//                        "Sheet not found in Treatment Schedule Excel: " +
//                                TREATMENT_SCHEDULE_SHEET);
//            }
//
//            for (Row row : sheet) {
...
//        } catch (Exception e) {
//            throw new RuntimeException(
//                    "Failed to read Treatment Schedule Excel", e);
//        }
//
 ...
 // ================= TREATMENT SCHEDULE TABLE (SAME EXCEL) =================
    public static String getTreatmentScheduleClipboardData() {
        ...
        try (FileInputStream fis = new FileInputStream(TESTDATA_FILE_PATH)) {
            ...
            if (sheet == null) {
                throw new RuntimeException(
                        "Sheet not found in TestData.xlsx: " +
                                TREATMENT_SCHEDULE_SHEET);
            }
            ...
            throw new RuntimeException(
                    "Failed to read Treatment Schedule from TestData.xlsx", e);
        }
 ...
 // ================= LOCATOR DATA =================
    public static Map<String, String> readLocators() {
        ...
        try (FileInputStream fis = new FileInputStream(TESTDATA_FILE_PATH)) {
            ...
            if (sheet == null) {
                throw new RuntimeException(
                        "Sheet 'Locators' not found in TestData.xlsx");
            }
            ...
            throw new RuntimeException(
                    "Failed to read Locators sheet from Excel", e);
        }
    ...
    public static String getLocator(String key) {
        ...
        if (value == null || value.isEmpty()) {
            throw new RuntimeException(
                    "Locator not found in Excel for key: " + key);
        }
 ...
 // ================= UNIQUE VALUE GENERATOR & PERSIST =================
    public static String generateAndPersistUniqueValue(String sheetName, String key) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Failed to generate and persist unique value for key: " + key, e);
        } finally {
            try {
