...
public class Fracpro2025Test extends CommonUtils {
	...
	public void selectCloudStorage() throws InterruptedException {
		...
		try {
			...
			Assert.assertEquals(actualTitle, "Well and Treatment Information - F3", "New window header is incorrect!");
			WindowsElement companyDropdown = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("CompanyDropdownLocator"));

			companyDropdown.click();
			Thread.sleep(1000);

			WindowsElement companyDropdownOption = driver.findElementByName(data.get("CompanyName"));
			companyDropdownOption.click();
			Thread.sleep(1000);

			WindowsElement FieldNameInput = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("FieldNameInputLoctor"));
			...
			// ===== PAD NAME =====
			String uniquePadName = ExcelReader.generateAndPersistUniqueValue("TestData", "PadName");

			WindowsElement padNameInput = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("PadNameInputLocator"));
			...
			// ===== WELL NAME =====
			String uniqueWellName = ExcelReader.generateAndPersistUniqueValue("TestData", "WellName");

			WindowsElement wellNameInput = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("WellNameInputLocator"));

			wellNameInput.clear();
			wellNameInput.sendKeys(uniqueWellName);
			Thread.sleep(1000);

			WindowsElement WellAPI1 = driver.findElementByAccessibilityId(ExcelReader.getLocator("WellAPI1Locator"));

			WellAPI1.clear();
			WellAPI1.sendKeys(data.get("API1"));
			Thread.sleep(1000);

			WindowsElement WellAPI2 = driver.findElementByAccessibilityId(ExcelReader.getLocator("WellAPI2Locator"));

			WellAPI2.clear();
			WellAPI2.sendKeys(data.get("API2"));
			Thread.sleep(1000);

			WindowsElement WellAPI3 = driver.findElementByAccessibilityId(ExcelReader.getLocator("WellAPI3Locator"));

			WellAPI3.clear();
			WellAPI3.sendKeys(data.get("API3"));
			Thread.sleep(1000);

			WindowsElement WellAPI4 = driver.findElementByAccessibilityId(ExcelReader.getLocator("WellAPI4Locator"));

			WellAPI4.clear();
			WellAPI4.sendKeys(data.get("API4"));
			Thread.sleep(1000);

			WindowsElement WellAPI5 = driver.findElementByAccessibilityId(ExcelReader.getLocator("WellAPI5Locator"));

			WellAPI5.clear();
			WellAPI5.sendKeys(data.get("API5"));
			Thread.sleep(1000);

			WindowsElement WellLocation = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("WellLocationLocator"));

			WellLocation.clear();
			WellLocation.sendKeys(data.get("WellLocation"));
			Thread.sleep(1000);

			WindowsElement CountyDropdown = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("CountyDropdownLocator"));

			CountyDropdown.click();
			Thread.sleep(1000);

			WindowsElement countryDropdownOption = driver.findElementByName(data.get("County"));
			countryDropdownOption.click();
			Thread.sleep(1000);

			WindowsElement ServiceCompanyDropdown = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("ServiceCompanyDropdownLocator"));

			ServiceCompanyDropdown.click();
			Thread.sleep(1000);

			WindowsElement ServiceCompanyDropdownOption = driver.findElementByName(data.get("ServiceCompany"));
			...
			WindowsElement Nextbutton = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("NextButtonLocator"));// 1347);
			Nextbutton.click();
			Thread.sleep(1000);
			...
			Assert.assertEquals(ActualTitle, "Fracture Analysis Options - F4", "New window header is incorrect!");

			WindowsElement Nextbutton1 = driver
					.findElementByAccessibilityId(ExcelReader.getLocator("NextButtonLocator"));// 1348
			Nextbutton1.click();
			Thread.sleep(1000);
